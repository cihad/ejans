...
describe Features::DateFeatureConfiguration do
  ...
  context "#feature_class" do
    specify { subject.feature_class.should == Features::DateFeature }
  end

  context "#partial_dir" do
    specify { subject.partial_dir.should == "features/date" }
  end

  context "#humanize_feature_name" do
    specify { subject.humanize_feature_name.should == "Date" }
  end
  ...
  context "#filter_query" do
    before do
      subject.label = "Label for Feature"
    end
